...
from keras.layers import Conv2D, MaxPool2D, BatchNormalization, Reshape, Dropout
...
def get_model(kernel_size=(3,3), pool_size=(2,2), first_filters=32, second_filters=64):
     ...
     model.add(Conv2D(32, kernel_size, activation = 'relu', padding = 'same', input_shape = (IMAGE_SIZE, IMAGE_SIZE, 3)))
