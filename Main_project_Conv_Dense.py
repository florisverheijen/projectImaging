...
def get_pcam_generators(base_dir, train_batch_size=1000, val_batch_size=32):
...
def get_model(kernel_size=(3,3), pool_size=(4,4), first_filters=32, second_filters=64, third_filter=64):
     ...
     #model.add(Dropout(0.1, noise_shape=None, seed=None))
     model.add(Dense(64, activation = 'relu'))
     # output layer with 1 nodes (binairy) and sigmoid nonlinearity
...
train_gen, val_gen = get_pcam_generators('C:/Users/s149478/Documents/Jaar3/Kwartiel3/8P531/Datasets')
